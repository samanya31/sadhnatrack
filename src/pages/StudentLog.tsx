          ...
          >
            <div className="flex items-center justify-between pb-1 border-b border-slate-100">
              ...
              <button
                ...
                className="p-1.5 rounded-xl text-slate-400 hover:text-slate-650 hover:bg-slate-50 transition-colors"
              >
...
export const StudentLog = () => {
  ...
  const saveDraft = async (dataToSave: typeof formData) => {
    if (dataToSave.status === 'submitted') return;
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in slide-in-from-top-2 duration-300">
                  <div>
                    ...
                    <div className="relative">
                      <Clock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-450" size={18} />
